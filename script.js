// Declaring stuff
  ...
  function setLetterSound(letterVariable) {
    ...
    mp3Source.src = 'https://sghome.github.io/Abecedario/' + letterVariable +'.mp3';
  ...
  document.onkeypress = function(event){ // Do stuff when you press any key in the document
    ...
    console.log(myName);
    if (myName==="sergio") {
      alert('Escribiste mi nombre!\n--------------------------------\nAhora les mostraré mi sitio web.');
      window.open('http://sergiosp.com','_blank');
    }
  ...
  document.getElementById('mute-button').onclick = function() {
    if (audioPlayer.muted === false) {
      ...
      document.getElementById('mute-button').innerHTML = "Активировать звук";
    } else {
      audioPlayer.muted = false;
      document.getElementById('mute-button').innerHTML = "Отключить звуки";
    }
  }
